...
>(({ className, ...rest }, ref) => (
	<>
		<svg
			className={cn("dark:text-neutral-100", className)}
			{...rest}
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 109 40.5"
			ref={ref}
		>
			<path fill="#fff" d="M98.6 14.2L93 12.9l-1-.4-25.7.2v12.4l32.3.1z" />
			<path
				fill="#f48120"
		...
		<VisuallyHidden.Root>Cloudflare</VisuallyHidden.Root>
	</>
));
